// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Implementation of SelfOrderedListADT using the transpose heruistics
...
template <typename E>
class Transpose_SOL : public SelfOrderedListADT<E> {
private:
...
public:
	...
	Transpose_SOL() { OrderedList = new LList<E>(); }
	~Transpose_SOL() { delete OrderedList; }
