...
// Modified by Chandler Whitley to seed the rand function with different values
inline void Randomize(int seedval) // Seed the generator with seedval passed in by user
{
	srand(seedval);
}
